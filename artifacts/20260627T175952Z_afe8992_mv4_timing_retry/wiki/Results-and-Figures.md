...
|---|---:|---:|---|
| MV1 | PRODUCTION | 100000 | AUC = 0.99719995921 |
...
- `CLAIM-MV1-SUMMARY`: MV1 has a frozen artifact-summary metric (hgb_auc=0.99719995921) for run 20260627T175952Z_afe8992_mv4_timing_retry.
- `CLAIM-MV2-SUMMARY`: MV2 has a frozen artifact-summary metric (proton_ekin_recon_res68=0.0153808233017) for run 20260627T175952Z_afe8992_mv4_timing_retry.
- `CLAIM-MV3-SUMMARY`: MV3 has a frozen artifact-summary metric (n_sample_I=6450) for run 20260627T175952Z_afe8992_mv4_timing_retry.
