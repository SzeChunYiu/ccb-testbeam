...
new saturation-residual fusion architecture.  The worker is `testbeam-laptop-1`.  The
...
The traditional comparator is **analytic_clipped_template_sideband_traditional**, the available raw-waveform analogue of a Birks/GEANT4-informed censored-likelihood template fit with explicit pedestal and pile-up nuisance terms.
...
cross-attention-style neural comparator requested by the ticket.  The new architecture is **saturation_residual_fusion_new**:
...
| method                                         |   pid_proxy_auc |   pid_proxy_ap |   pid_proxy_brier |   pid_proxy_ece |   n_heldout |
|:-----------------------------------------------|----------------:|---------------:|------------------:|----------------:|------------:|
| 1d_cnn                                         |          0.8162 |         0.8228 |            0.1734 |         0.05205 |         780 |
| saturation_residual_fusion_new                 |          0.8398 |         0.8629 |            0.1658 |         0.06373 |         780 |
| gradient_boosted_trees                         |          0.8393 |         0.8584 |            0.1678 |         0.06932 |         780 |
| mlp                                            |          0.8493 |         0.8456 |            0.1696 |         0.09593 |         780 |
| tiny_sequence_transformer                      |          0.7969 |         0.7944 |            0.209  |         0.1394  |         780 |
| ridge                                          |          0.8493 |         0.8495 |            0.1889 |         0.1653  |         780 |
| analytic_clipped_template_sideband_traditional |          0.6226 |         0.668  |            0.3596 |         0.3385  |         780 |
...
| method                                         |   n_recovered_doublets |   coverage_abs_energy_error_le_5pct |   coverage_abs_energy_error_le_10pct |   coverage_abs_energy_error_le_15pct |
|:-----------------------------------------------|-----------------------:|------------------------------------:|-------------------------------------:|-------------------------------------:|
| 1d_cnn                                         |                    286 |                              0.3636 |                               0.6469 |                               0.8112 |
| analytic_clipped_template_sideband_traditional |                    162 |                              0.2778 |                               0.5988 |                               0.7284 |
| gradient_boosted_trees                         |                    252 |                              0.4841 |                               0.8095 |                               0.9365 |
| mlp                                            |                    240 |                              0.225  |                               0.4667 |                               0.675  |
| ridge                                          |                    271 |                              0.5424 |                               0.8413 |                               0.9262 |
| saturation_residual_fusion_new                 |                    257 |                              0.5409 |                               0.8599 |                               0.9494 |
| tiny_sequence_transformer                      |                    158 |                              0.4051 |                               0.6646 |                               0.8544 |
...
| method                                         |   n_recovered_doublets |   spearman_true_vs_pred_energy |   adjacent_inversion_rate |
|:-----------------------------------------------|-----------------------:|-------------------------------:|--------------------------:|
| saturation_residual_fusion_new                 |                    257 |                         0.9642 |                    0.4297 |
| analytic_clipped_template_sideband_traditional |                    162 |                         0.9655 |                    0.4534 |
| gradient_boosted_trees                         |                    252 |                         0.9598 |                    0.4661 |
| ridge                                          |                    271 |                         0.9578 |                    0.4741 |
| 1d_cnn                                         |                    286 |                         0.9534 |                    0.4772 |
| tiny_sequence_transformer                      |                    158 |                         0.9505 |                    0.4841 |
| mlp                                            |                    240 |                         0.8336 |                    0.4854 |

## Winner Failure Slices

The following slices identify where `saturation_residual_fusion_new` remains weakest after run-held-out
selection.  Rows are sorted by pile-up miss rate, then energy resolution.

| slice_axis       | slice_value       |   n |   n_positive |   pileup_miss_rate |   false_split_rate |   energy_sigma68 |   energy_abs_bias |
|:-----------------|:------------------|----:|-------------:|-------------------:|-------------------:|-----------------:|------------------:|
| ratio_bin        | (-0.001, 0.35]    | 469 |           79 |             0.5316 |            0.1359  |          0.05611 |         0.01445   |
| spacing_bin      | (-0.001, 10.0]    | 132 |          132 |             0.447  |          nan       |          0.06808 |         0.02005   |
| spacing_bin      | (10.0, 25.0]      |  88 |           88 |             0.4432 |          nan       |          0.047   |         0.03716   |
| morphology_state | late_tail_high    | 411 |          173 |             0.4162 |            0.09244 |          0.05655 |         0.0144    |
| stave            | B2                | 183 |           91 |             0.4066 |            0.1413  |          0.07231 |         0.03605   |
| stave            | B6                | 186 |           85 |             0.3882 |            0.05941 |          0.05845 |         0.004977  |
| pid_proxy_class  | other             | 754 |          366 |             0.3525 |            0.1366  |          0.06637 |         0.003439  |
| saturation_bin   | 0                 | 771 |          381 |             0.3491 |            0.1359  |          0.06708 |         0.0005698 |
| pedestal_state   | shifted           | 497 |          255 |             0.349  |            0.1694  |          0.07185 |         0.002127  |
| ratio_bin        | (0.35, 0.625]     | 109 |          109 |             0.3486 |          nan       |          0.06766 |         0.002731  |
| pedestal_state   | nominal           | 283 |          135 |             0.3259 |            0.08108 |          0.058   |         0.005258  |
| stave            | B4                | 205 |          107 |             0.3178 |            0.1633  |          0.06939 |         0.02075   |
| ratio_bin        | (0.625, 0.875]    |  89 |           89 |             0.3146 |          nan       |          0.07181 |         0.0005419 |
| morphology_state | late_tail_low     | 369 |          217 |             0.2811 |            0.2039  |          0.06846 |         0.01013   |
| stave            | B8                | 206 |          107 |             0.271  |            0.1818  |          0.05262 |         0.007256  |
| spacing_bin      | (25.0, 45.0]      |  78 |           78 |             0.2308 |          nan       |          0.06535 |         0.000395  |
| ratio_bin        | (0.875, 1.05]     | 113 |          113 |             0.2212 |          nan       |          0.06171 |         0.002825  |
| spacing_bin      | (45.0, 70.0]      |  92 |           92 |             0.1848 |          nan       |          0.05886 |         0.04578   |
| pid_proxy_class  | inner_high_charge |  26 |           24 |             0.1667 |            0       |          0.07284 |         0.04702   |
| saturation_bin   | 1-2               |   4 |            4 |             0      |          nan       |          0.08318 |         0.01375   |
| saturation_bin   | 3-5               |   5 |            5 |             0      |          nan       |          0.01253 |         0.007812  |
...
Use `saturation_residual_fusion_new` as the preferred S66c controlled-overlay energy/PID-proxy calibration method
...
Runtime was `55.6` s on `Linux-5.15.0-139-generic-x86_64-with-glibc2.35`.
