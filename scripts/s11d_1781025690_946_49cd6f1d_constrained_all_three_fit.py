#!/usr/bin/env python3
"""S11d: constrained two-pulse fit comparator for the all-three injected target."""
...
os.environ.setdefault("MPLCONFIGDIR", "/tmp/ccb-testbeam-s11d-1781025690-mpl")
...
def main() -> int:
    ...
    parser.add_argument("--config", default="configs/s11d_1781025690_946_49cd6f1d_constrained_all_three_fit.json")
    ...
    s07f = load_module("s07f_source_for_s11d_1781025690_all_three", ROOT / config["s07f_script"])
    fitmod = load_module("s11b_fit_source_for_s11d_1781025690_all_three", ROOT / config["s11b_fit_script"])
    ...
    manifest = {
        ...
        "python": sys.version,
        "command": f"/home/billy/anaconda3/bin/python scripts/s11d_1781025690_946_49cd6f1d_constrained_all_three_fit.py --config {config_path.relative_to(ROOT)}",
        "inputs": input_rows,
        "outputs": {},
    }
