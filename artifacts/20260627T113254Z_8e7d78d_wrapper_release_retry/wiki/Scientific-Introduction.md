...
This wiki draft introduces the CCB testbeam MC validation status for run `20260627T113254Z_8e7d78d_wrapper_release_retry`. The goal is to compare frozen MC validation artifacts against detector-analysis questions while keeping production, fixture, blocked, and release states distinct.
