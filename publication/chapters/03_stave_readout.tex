...
\PaperFigure{figures/final/stave_geometry.pdf}{0.88}{B-stack stave geometry (DESIGN\_SPEC per issue \#796). Dimensions: 50 cm $\times$ 5.18 cm $\times$ 2.0 cm (L$\times$W$\times$H); two 2.0 mm longitudinal holes at 2.0 cm spacing; 1.8 mm Kuraray Y-11 fibres; one-fibre one-end readout. Source-bound hardware drawing/BOM required for publication metrology.}{DESIGN\_SPEC; see publication/tables/hardware\_bom.csv and issue \#1296.}
