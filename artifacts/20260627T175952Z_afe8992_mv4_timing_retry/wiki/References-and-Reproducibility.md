...
```bash
python scripts/mc_validation/run_pipeline.py --run-id 20260627T175952Z_afe8992_mv4_timing_retry release
python scripts/mc_validation/run_pipeline.py --run-id 20260627T175952Z_afe8992_mv4_timing_retry qa
```
