# S02f: leave-one-run-out current/rate drift scan

Ticket `1781022115.1020.625b5a98`. Worker `testbeam-laptop-2`.
...
|            58 | S02f binned current/rate selected power 0       | 3.63484 |  3.12331 |   4.09119 |                 73 |            0.191781   |
|            58 | S02b global timewalk no covariate               | 1.52279 |  1.26152 |   1.86424 |                 73 |            0.0228311  |
|            58 | S02f global current/rate selected power 0       | 1.52279 |  1.26255 |   1.87971 |                 73 |            0.0228311  |
...
|            59 | S02f binned current/rate selected power 0       | 3.63793 |  3.48338 |   3.79946 |                763 |            0.158148   |
|            59 | S02b global timewalk no covariate               | 1.59676 |  1.54867 |   1.65049 |                763 |            0.0126693  |
|            59 | S02f global current/rate selected power 0       | 1.59676 |  1.54186 |   1.65037 |                763 |            0.0126693  |
...
|            60 | S02f binned current/rate selected power 0       | 2.12741 |  2.05083 |   2.20272 |                808 |            0.0383663  |
|            60 | S02b global timewalk no covariate               | 1.4719  |  1.42633 |   1.52379 |                808 |            0.0107261  |
|            60 | S02f global current/rate selected power 0       | 1.4719  |  1.42397 |   1.52188 |                808 |            0.0107261  |
...
|            61 | S02f binned current/rate selected power 0       | 3.06904 |  2.91237 |   3.1707  |                933 |            0.110397   |
|            61 | S02b global timewalk no covariate               | 2.18842 |  2.08933 |   2.26788 |                933 |            0.0275098  |
|            61 | S02f global current/rate selected power 0       | 2.18842 |  2.08516 |   2.26464 |                933 |            0.0275098  |
...
|            62 | S02f binned current/rate selected power 0       | 2.962   |  2.8445  |   3.07729 |                807 |            0.0912846  |
|            62 | S02b global timewalk no covariate               | 1.62995 |  1.57677 |   1.675   |                807 |            0.0111524  |
|            62 | S02f global current/rate selected power 0       | 1.62995 |  1.577   |   1.67588 |                807 |            0.0111524  |
...
|            63 | S02f binned current/rate selected power 0       | 3.20453 |  3.00087 |   3.43878 |                370 |            0.123423   |
|            63 | S02b global timewalk no covariate               | 1.54092 |  1.47551 |   1.59832 |                370 |            0.0171171  |
|            63 | S02f global current/rate selected power 0       | 1.54092 |  1.47984 |   1.61062 |                370 |            0.0171171  |
...
|            65 | S02f binned current/rate selected power 0       | 3.4037  |  2.8981  |   4.0201  |                 66 |            0.141414   |
|            65 | S02b global timewalk no covariate               | 1.63542 |  1.46243 |   1.91718 |                 66 |            0.00505051 |
|            65 | S02f global current/rate selected power 0       | 1.63542 |  1.47515 |   1.92971 |                 66 |            0.00505051 |
...
| S02f global current/rate selected power 0       |           1.65516 |  1.53023 |   1.8445  |              1.4719  |              2.18842 |
...
| S02f binned current/rate selected power 0       |           3.14849 |  2.75413 |   3.46085 |              2.12741 |              3.63793 |
...
Pre-timing current/rate covariates do not rescue the S02d drift nuisance in a full Sample-II leave-one-run-out scan: train-run CV selects the zero-covariate branch in every fold, so the constrained current/rate basis is rejected rather than adopted. The global-template traditional comparator is the best mean held-out sigma68 in this split, while ML ridge is competitive but worse on the run-block mean. The shuffled-target failures are confined to the binned branch and are reported as instability diagnostics, not as evidence of train/held-out leakage.
