...
def launch(
    *,
    ...
    try:
        ...
        # Re-hash through the same executable descriptor immediately before
        # publication/exec. This narrows, but cannot remove, an in-place-write
        # window; that residual is explicit in the receipt limitations.
        ...
        # The target is an ELF binary, so O_CLOEXEC on its descriptor is safe.
        # No code after a successful call runs.
