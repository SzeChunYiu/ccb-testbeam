...
> **Draft / not final release.** This wiki export is generated from frozen artifacts for run `20260627T175724Z_c6ba16a_mv4_timing`. Release audit status is `BLOCKED` with `release_ready=False`. Do not treat this as a final publication until all blockers are cleared.
...
- Generated: `2026-06-27T17:57:50.519101+00:00`

## Headline artifact metrics

| Study | Status | Support | Headline artifact metric |
|---|---:|---:|---|
| MV1 | PRODUCTION | 100000 | AUC = 0.99728749681 |
