...
- **Git commit:** `8bc0601c88c42f95f676e3337367708227b05d6f`
...
| Quantity | Value |
|---|---:|
| filesystem/archive rows audited | 501 |
...
|:--------------------------------|--------:|------------------:|------------:|
| analysis_pdf_not_daq_logbook    |      29 |                 0 |         382 |
| derived_or_unsupported          |       4 |                 0 |          18 |
| derived_repo_document_or_report |      91 |                 0 |         795 |
