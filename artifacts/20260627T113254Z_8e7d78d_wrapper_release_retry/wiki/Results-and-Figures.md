...
|---|---:|---:|---|
| MV1 | PRODUCTION | 100000 | AUC = 0.997356536709 |
...
- `CLAIM-MV1-SUMMARY`: MV1 has a frozen artifact-summary metric (hgb_auc=0.997356536709) for run 20260627T113254Z_8e7d78d_wrapper_release_retry.
- `CLAIM-MV2-SUMMARY`: MV2 has a frozen artifact-summary metric (proton_ekin_recon_res68=0.0153808233017) for run 20260627T113254Z_8e7d78d_wrapper_release_retry.
- `CLAIM-MV3-SUMMARY`: MV3 has a frozen artifact-summary metric (n_sample_I=6450) for run 20260627T113254Z_8e7d78d_wrapper_release_retry.
