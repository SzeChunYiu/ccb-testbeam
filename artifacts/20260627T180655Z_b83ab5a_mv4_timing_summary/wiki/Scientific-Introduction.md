...
This wiki draft introduces the CCB testbeam MC validation status for run `20260627T180655Z_b83ab5a_mv4_timing_summary`. The goal is to compare frozen MC validation artifacts against detector-analysis questions while keeping production, fixture, blocked, and release states distinct.
