...
TICKET = "1783809165.2768.748951b9"
WORKER = "testbeam-laptop-3"
SLUG = "s29b_pileup_saturation_energy_recovery_study"
OUT = ROOT / "reports" / f"{TICKET}__{SLUG}"
TITLE = "S29b pile-up saturation energy recovery study"
...
def refresh_manifest() -> None:
    ...
    manifest["command"] = (
        f"{sys.executable} "
        "scripts/s29b_1783809165_2768_748951b9_pileup_saturation_energy_recovery_study.py"
    )
