...
The current artifact-summary scope covers MV1, MV2, MV3, and MV9 frozen outputs for run `20260627T113254Z_8e7d78d_wrapper_release_retry`. MV4-MV8 and systematic arrays are blocked pending calibrated digitized MC.
