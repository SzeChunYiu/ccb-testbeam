# S11e: full constrained two-pulse fit for all-three App.I target

- **Ticket:** `1781024319.1354.2db2173f`
...
| ------------ | --------- | ---------------- | -------- | ----------------- | -------- |
| 500          | 7         | 8                | 0.825997 | 0.837097          | 0.172582 |
| 400          | 5         | 15               | 0.793936 | 0.808837          | 0.188982 |
| 300          | 4         | 20               | 0.777141 | 0.794562          | 0.192291 |

## Head-to-Head

| method                           | roc_auc  | roc_auc_ci_low | roc_auc_ci_high | average_precision | ap_ci_low | ap_ci_high | brier    | brier_ci_low | brier_ci_high | notes                                                                                                                                                              |
| -------------------------------- | -------- | -------------- | --------------- | ----------------- | --------- | ---------- | -------- | ------------ | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| bounded two-pulse fit outputs    | 0.607549 | 0.59384        | 0.622429        | 0.632821          | 0.601922  | 0.655431   | 0.239429 | 0.234687     | 0.24657       | Fold-local score selected from constrained-fit outputs only: secondary fraction/amplitude, delay, chi2/ndf, SSE, and fractional SSE improvement.                   |
| direct D_t/curvature cross-check | 0.530522 | 0.516347       | 0.537455        | 0.581449          | 0.565868  | 0.597919   | 0.24422  | 0.241072     | 0.247529      | Diagnostic only; label is injected truth, not a D_t tail threshold.                                                                                                |
| shape-only RF                    | 0.825997 | 0.800127       | 0.850805        | 0.837097          | 0.813296  | 0.863385   | 0.172582 | 0.159503     | 0.186606      | Best params={'n_estimators': 500, 'max_depth': 7, 'min_samples_leaf': 8}; excludes timing, ids, injection parameters, amplitudes, topology flags, and fit outputs. |
...
| absolute-amplitude-only RF             | 0.563162 | 0.56853           | Excluded from main RF; injection changes peak height. |
| shape RF with shuffled training labels | 0.494076 | 0.487735          | Null/leakage sanity check.                            |
| per-stave slot shape RF                | 0.850891 | 0.854972          | Permissive shape representation; not main claim.      |
...
The full bounded fit improves interpretability but does not close the S07f RF gap. On the same all-three injected target, fit-output-only scoring reaches ROC AUC **0.608** [0.594, 0.622], while the shape-only RF reaches **0.826** [0.800, 0.851]. The RF advantage is **0.218** AUC.
