#!/usr/bin/env python3
"""S33a: rate-baseline energy and PID robustness benchmark.
...
def make_report(
    ...
    lines = [
        "# S33a: Rate-Dependent Pedestal, Energy, and PID Robustness Benchmark",
        "",
        "## Abstract",
        "",
        (
            "This ticket studies whether rate-dependent pedestal structure changes energy calibration "
            "and PID-like charge-depth discrimination in raw B-stack data. The analysis reads the raw "
            ...
            "new range-gated residual MLP, and estimates 95% confidence intervals by held-out run "
        ...
        "",
        "```bash",
        "/home/billy/anaconda3/bin/python scripts/s33a_1784062062_882_024708b9_rate_baseline_energy_pid_benchmark.py --config configs/s33a_1784062062_882_024708b9_rate_baseline_energy_pid_benchmark.yaml",
        "```",
    ]
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/s33a_1784062062_882_024708b9_rate_baseline_energy_pid_benchmark.yaml")
