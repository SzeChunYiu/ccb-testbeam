...
| Check | Status | Reason |
|---|---:|---|
| artifact_validation | BLOCKED | expected status=PASS, observed BLOCKED |
...
| MV4_production_artifact | BLOCKED | missing production study artifact |
| MV4_timing_uncertainty_artifact | BLOCKED | expected status=PASS, observed BLOCKED |
