...
| CLAIM-MV1-SUMMARY | SUPPORTED | MV1 has a frozen artifact-summary metric (hgb_auc=0.99719995921) for run 20260627T175952Z_afe8992_mv4_timing_retry. | Summary metric only; uncertainty/systematic and publication-grade figure requirements remain separate gates. |
| CLAIM-MV2-SUMMARY | SUPPORTED | MV2 has a frozen artifact-summary metric (proton_ekin_recon_res68=0.0153808233017) for run 20260627T175952Z_afe8992_mv4_timing_retry. | Summary metric only; uncertainty/systematic and publication-grade figure requirements remain separate gates. |
| CLAIM-MV3-SUMMARY | SUPPORTED | MV3 has a frozen artifact-summary metric (n_sample_I=6450) for run 20260627T175952Z_afe8992_mv4_timing_retry. | Summary metric only; uncertainty/systematic and publication-grade figure requirements remain separate gates. |
