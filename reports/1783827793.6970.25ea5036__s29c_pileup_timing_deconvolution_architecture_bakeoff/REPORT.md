...
Ticket `1783827793.6970.25ea5036` asks for a run-held-out architecture bakeoff for pulse timing
under controlled pile-up.  The worker was `testbeam-laptop-3` and the project was
...
Runtime was `384.6` s on `Linux-5.15.0-139-generic-x86_64-with-glibc2.35`.
