...
- **Date:** 2026-07-05 20:39:05
- **Input:** 450 `reports/*/result.json` artifacts
...
- Artifacts found: **450**
- Artifacts no delta ci claims: **242**
- Artifacts with claims: **208**
- Claims parsed: **1957**
...
- Artifacts with zero extractable delta-CI claims are listed in `artifacts_without_claims.txt` (242 files); these include verdict-only, count-only, and classifier-metric-only artifacts.
...
|---|---|---|---|---|---|
| amplitude-charge | 30 | 747 | 471 | 432 | 92% |
| pedestal | 14 | 282 | 231 | 225 | 97% |
| pid | 5 | 30 | 18 | 17 | 94% |
| pileup | 35 | 191 | 131 | 129 | 98% |
| representation | 27 | 409 | 372 | 372 | 100% |
| timing | 46 | 298 | 221 | 200 | 90% |
| **total** | 157 | **1957** | **1444** | **1375** | 95% |

## Scoreboard bold wins vs BH

The rolling scoreboard (`reports/SUMMARY.md`) marks 15 rows as bold ML wins. Per-study verdicts against the family-level BH pass:
...
| P04 | amplitude-charge | 2 | 2 | 2 | survives BH (at least one claim) |
| P04c | amplitude-charge | 1 | 1 | 1 | survives BH (at least one claim) |
| P04d | amplitude-charge | 1 | 1 | 1 | survives BH (at least one claim) |
| P04e | amplitude-charge | 1 | 1 | 1 | survives BH (at least one claim) |
| P05b | pileup | 2 | 1 | 1 | survives BH (at least one claim) |
| P07 | amplitude-charge | 4 | 4 | 4 | survives BH (at least one claim) |

**Headline:** of 15 scoreboard bold wins, **14 survive BH** (at least one delta-CI claim), **0 fail BH**, and **1 have no machine-readable delta CI at all** (win asserted in prose/derived numbers only).
