...
- **Generated:** `2026-06-27T11:23:56.236026+00:00`
...
- `run_summary_html`: missing artifact
- `run_summary_metrics`: missing artifact
- `artifact_notebook_manifest`: missing artifact
- `artifact_report_manifest`: missing artifact
- `summary_figure_manifest`: missing artifact
- `summary_visual_review`: missing artifact
...
```bash
python scripts/mc_validation/run_pipeline.py --run-id 20260627T111955Z_e3ac99f_current_main_retry1 thesis
```
