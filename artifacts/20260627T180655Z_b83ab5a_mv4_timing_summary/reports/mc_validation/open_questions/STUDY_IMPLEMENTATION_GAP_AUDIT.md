...
|---|---:|---|---|---|
| MV4 | READY | `ccb_mc_validation.studies.mv4_timing` | truth-timing diagnostic implemented; final ADC pickoff calibration remains an open evidence-packet blocker | `reports/mc_validation/systematics/MV4_TIMING_UNCERTAINTIES.json` |
