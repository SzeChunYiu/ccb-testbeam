...
The table below is a meeting aid assembled from the current manuscript state. It is intentionally mixed-status: each row states whether it is beam-data, simulation or a control, and none of the gated rows is promoted by appearing here.

\begin{table}[H]
\centering
\small
\begin{tabular}{p{0.25\linewidth}p{0.49\linewidth}p{0.18\linewidth}}
\toprule
...
\bottomrule
\end{tabular}
\caption{Internal rough-paper summary of the principal numbers currently shaping the manuscript. Status and interpretation remain those of the main chapters.}
\end{table}
