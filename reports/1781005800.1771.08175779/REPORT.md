...
- **Ticket:** 1781005800.1771.08175779
- **Author:** testbeam-laptop-4
- **Date:** 2026-06-09
- **Input:** raw B-stack ROOT files under `data/root/root`
- **Split:** train runs 58-63; held-out run 65
- **Config:** `configs/s03b_1781005800_1771_08175779.yaml`
...
```bash
/home/billy/anaconda3/bin/python scripts/s03b_amp_binned_monotonic_timewalk.py --config configs/s03b_1781005800_1771_08175779.yaml
```
