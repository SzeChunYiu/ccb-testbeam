...
energy response under clipped tails and overlapping pulses.  The worker is `testbeam-laptop-4`.  The
...
Use `saturation_residual_fusion_new` as the preferred S68b/#2555 controlled-overlay energy-closure method
...
Runtime was `55.0` s on `Linux-5.15.0-139-generic-x86_64-with-glibc2.35`.
...
| check                           | passed   | detail                                                               |
|:--------------------------------|:---------|:---------------------------------------------------------------------|
| raw_root_reproduction_pass      | True     | delta=0; reproduced=640737                                           |
| run_split_disjoint              | True     | train=[50, 51, 52, 53, 54, 55, 56, 57]; heldout=[58, 60, 62, 64, 65] |
| no_event_id_crosses_split       | True     | max_splits_per_event=1                                               |
| no_train_rows_from_heldout_runs | True     | train rows contain no held-out source runs                           |
| no_heldout_rows_from_train_runs | True     | held-out rows contain no train source runs                           |
| required_methods_present        | True     | missing=[]                                                           |
...
| saturation_knee   | method                                         |   n_events |   median_fractional_energy_residual |   sigma68_fractional_energy |
|:------------------|:-----------------------------------------------|-----------:|------------------------------------:|----------------------------:|
| knee_1_2          | 1d_cnn                                         |          4 |                           -0.01671  |                     0.0987  |
| knee_1_2          | analytic_clipped_template_sideband_traditional |          4 |                          nan        |                   nan       |
| knee_1_2          | gradient_boosted_trees                         |          4 |                            0.03136  |                     0.07211 |
| knee_1_2          | mlp                                            |          4 |                           -0.05088  |                     0.09073 |
| knee_1_2          | ridge                                          |          4 |                           -0.002575 |                     0.07896 |
| knee_1_2          | saturation_residual_fusion_new                 |          4 |                           -0.002311 |                     0.07841 |
| knee_1_2          | tiny_sequence_transformer                      |          4 |                           -0.03803  |                     0.09451 |
| plateau_3_5       | 1d_cnn                                         |          5 |                           -0.01702  |                     0.02001 |
| plateau_3_5       | analytic_clipped_template_sideband_traditional |          5 |                          nan        |                   nan       |
| plateau_3_5       | gradient_boosted_trees                         |          5 |                           -0.04276  |                     0.03807 |
| plateau_3_5       | mlp                                            |          5 |                           -0.1059   |                     0.04671 |
| plateau_3_5       | ridge                                          |          5 |                           -0.04979  |                     0.01396 |
| plateau_3_5       | saturation_residual_fusion_new                 |          5 |                           -0.01081  |                     0.01219 |
| plateau_3_5       | tiny_sequence_transformer                      |          5 |                           -0.1272   |                     0.05484 |
| unclipped         | 1d_cnn                                         |        381 |                            0.0377   |                     0.1113  |
| unclipped         | analytic_clipped_template_sideband_traditional |        381 |                          nan        |                   nan       |
| unclipped         | gradient_boosted_trees                         |        381 |                            0.002731 |                     0.07696 |
| unclipped         | mlp                                            |        381 |                           -0.01063  |                     0.1851  |
| unclipped         | ridge                                          |        381 |                           -0.01031  |                     0.07223 |
| unclipped         | saturation_residual_fusion_new                 |        381 |                            0.0108   |                     0.07649 |
| unclipped         | tiny_sequence_transformer                      |        381 |                           -0.008794 |                     0.1093  |
...
| method                                         |   energy_fractional_sigma68 |   delta_vs_traditional_energy_fractional_sigma68 |   pileup_miss_rate |   delta_vs_traditional_pileup_miss_rate |   energy_fractional_bias |   delta_vs_traditional_energy_fractional_bias |
|:-----------------------------------------------|----------------------------:|-------------------------------------------------:|-------------------:|----------------------------------------:|-------------------------:|----------------------------------------------:|
| saturation_residual_fusion_new                 |                     0.06839 |                                       -0.03224   |             0.3256 |                                -0.259   |               -0.002907  |                                      -0.08208 |
| gradient_boosted_trees                         |                     0.07328 |                                       -0.02734   |             0.3538 |                                -0.2308  |               -0.004337  |                                      -0.08351 |
| ridge                                          |                     0.06713 |                                       -0.0335    |             0.3051 |                                -0.2795  |               -0.01034   |                                      -0.08951 |
| 1d_cnn                                         |                     0.09965 |                                       -0.0009785 |             0.2667 |                                -0.3179  |                0.04774   |                                      -0.03144 |
| analytic_clipped_template_sideband_traditional |                     0.1006  |                                        0         |             0.5846 |                                 0       |                0.07918   |                                       0       |
| tiny_sequence_transformer                      |                     0.1027  |                                        0.002027  |             0.5949 |                                 0.01026 |                0.0006918 |                                      -0.07849 |
| mlp                                            |                     0.1571  |                                        0.05645   |             0.3846 |                                -0.2     |               -0.02341   |                                      -0.1026  |

## Claim Provenance

The required helper command was run exactly once as `tn-ticket claim testbeam-laptop-4 --project testbeam`.  It
returned the null pseudo-ticket pattern (`stderr: null; stdout: # null / null`), while the project
queue still contained open tickets.  Without invoking `tn-ticket claim` again,
issue `#2555` was claimed by the manual label-swap recovery `gh issue edit 2555 --repo SzeChunYiu/factory-tickets --add-label factory:claimed --add-label worker:testbeam-laptop-4 --remove-label factory:open`.
Completion is recorded with `tn-ticket done 2555`.  No novel follow-up ticket was
appended.
