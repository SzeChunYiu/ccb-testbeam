# S29A: Pedestal-shape timing frontier study

## Abstract

This study reproduces the S29A B-stave selected-pulse number directly from raw ROOT and then benchmarks a traditional pedestal-subtracted constant-fraction/template timing baseline against ridge, gradient-boosted trees, MLP, 1D-CNN, a waveform transformer, and a new gated residual CNN. The winner is **mlp** under held-out-run timing-residual res68 with run-block bootstrap confidence intervals.
...
|:-----------------------------|-------:|------------------------:|:--------------------------------------------|------------------:|:-------------------------------------------|--------------------:|:-------------------------------------------------|-------------------------:|:-------------------------------------------------|------------------------:|:----------------------------------------------|
| mlp                          | 167683 |               0.0159003 | [0.014162061414122578, 0.01841149074018001] |         0.0520643 | [0.041845816205733063, 0.0629174083976873] |          0.00292055 | [0.0016701180413365266, 0.003975319374352687]    |              -0.00394364 | [-0.006478132280707365, -0.001570100305080422]   |              0.00029332 | [9.540268001363276e-05, 0.004695781394522311] |
| traditional_clipped_template | 167683 |               0.0299608 | [0.027511029857142204, 0.03303475614542952] |         0.141024  | [0.11116764640502595, 0.17108123335358097] |          0.00116275 | [-0.00017297738323740277, 0.0025326164483023828] |               0.00671881 | [0.004167043527646669, 0.00912676011949084]      |              0.135768   | [0.10075940343985122, 0.1810730158397414]     |
| gradient_boosted_trees       | 167683 |               0.0332068 | [0.02984716186433946, 0.037954409174035676] |         0.0783139 | [0.06222091537900172, 0.0948179139665819]  |         -0.0136946  | [-0.015822824996310908, -0.011690478889581852]   |              -0.00769052 | [-0.009949897170462317, -0.004778400032789632]   |              0.0384673  | [0.03111906014894034, 0.04709929246409914]    |
| 1d_cnn                       | 167683 |               0.0385764 | [0.0352931073100865, 0.042278885729908955]  |         0.0942664 | [0.07738540283465561, 0.11061839473359782] |         -0.0095124  | [-0.010568653196096433, -0.008108760748058566]   |              -0.00544583 | [-0.0075312907320260886, -0.0025156372708082324] |              0.00816724 | [0.0009242772945742822, 0.018491375662398397] |
| charge_tail_integration      | 167683 |               0.0482599 | [0.04355560229268362, 0.053582388067677574] |         0.205711  | [0.1541255282490798, 0.25526635116998736]  |          0.00382681 | [-0.0055180851850210825, 0.012641397166535888]   |               0.00368262 | [-0.004946554592252249, 0.010729161055718663]    |              0.0836953  | [0.03614432441657053, 0.1395698705724507]     |
| birks_huber_saturation       | 167683 |               0.050402  | [0.04308824944601026, 0.058156388811403996] |         0.235151  | [0.17567817150905077, 0.3021244214861927]  |         -0.00835227 | [-0.014149162394341091, -0.0039765794816713305]  |              -0.0208846  | [-0.025938007602366194, -0.014584492327451468]   |              0.111956   | [0.05545952486055529, 0.17648175816328487]    |
| gated_residual_cnn           | 167683 |               0.0620691 | [0.05279361670196057, 0.07380660544693472]  |         0.113529  | [0.09090577171366793, 0.13554186987700267] |          0.0227181  | [0.02040526939183473, 0.026324028000235544]      |              -0.0334945  | [-0.04152493171274664, -0.025008645605444954]    |              0.0120741  | [0.005302258461850228, 0.020323761515633566]  |
| waveform_transformer         | 167683 |               0.0730861 | [0.0667771150121093, 0.08059666297584772]   |         0.109517  | [0.09213072729095051, 0.12504913034804818] |          0.0403892  | [0.03756075784564017, 0.043359984844923025]      |              -0.033663   | [-0.03852421011030675, -0.02878286312520505]     |              0.0142048  | [0.005546264979031659, 0.025055794130937656]  |
| ridge                        | 167683 |               0.163625  | [0.13384319840125594, 0.20764489538537206]  |         0.210551  | [0.17467821138023276, 0.24780456005356713] |          0.0180394  | [0.004502312697528382, 0.033863064859206364]     |              -0.0719739  | [-0.11266641639221794, -0.04146807107012613]     |              0.0433052  | [0.019776802244391496, 0.05951352336988702]   |

The table reports the requested frontier diagnostics. `timing_residual_res68` is the 68th percentile absolute residual of the duplicate-readout anchored timing/shape target. `shape_error_mae` is the mean absolute target error. `energy_proxy_bias` is the median signed residual on the charge-loss component scale. `saturation_sensitivity` is saturated minus unsaturated timing-residual res68. `pid_leakage_abs_delta` is the absolute PID-proxy mean residual difference. All intervals are run-block bootstrap 95% CIs.

## Saturation and Pile-Up Strata

| stratum                 | method                       |      n |         bias |     res68 | res68_ci95                                   |       mae |
|:------------------------|:-----------------------------|-------:|-------------:|----------:|:---------------------------------------------|----------:|
| all_heldout             | mlp                          | 167683 |  0.00292055  | 0.0159003 | [0.01395424178838729, 0.01910582464933395]   | 0.0520643 |
...
| near_knee               | mlp                          |  58040 |  0.00712556  | 0.01264   | [0.012051689634919158, 0.013883150258958329] | 0.0175423 |
...
| hard_saturated          | mlp                          |  42426 |  0.00909013  | 0.0136596 | [0.012855163325071327, 0.014887044075727456] | 0.0176327 |
...
| pileup_multiplicity_ge2 | mlp                          |  18863 | -0.00474232  | 0.0646463 | [0.05953243200093509, 0.07188788509130474]   | 0.100009  |
...
| high_recovery_tail      | mlp                          |  52370 |  0.00272178  | 0.0139345 | [0.012374060472249983, 0.01615596299111844]  | 0.0186265 |
...
| high_pedestal_drift     | mlp                          |  41243 | -0.000667154 | 0.0695845 | [0.03140258810065691, 0.11985322162359956]   | 0.16348   |
...
| large_timing_bias_proxy | mlp                          |  74071 | -0.00161995  | 0.0193623 | [0.016766536812782288, 0.022133516167998322] | 0.0711574 |
...
The winner's waveform recovery score is accompanied by a PID separability diagnostic: held-out AUC=0.4294, AP=0.3391. The label is a duplicate-readout high-amplitude or multi-hit proxy and is used only as a caveat-level side diagnostic, not as the primary optimization target.
