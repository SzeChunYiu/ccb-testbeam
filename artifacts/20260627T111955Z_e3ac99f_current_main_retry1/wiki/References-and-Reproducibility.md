...
```bash
python scripts/mc_validation/run_pipeline.py --run-id 20260627T111955Z_e3ac99f_current_main_retry1 release
python scripts/mc_validation/run_pipeline.py --run-id 20260627T111955Z_e3ac99f_current_main_retry1 qa
```
