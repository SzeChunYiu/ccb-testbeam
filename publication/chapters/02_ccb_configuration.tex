...
\\PaperFigure{figures/illustrative/geometry_tof.png}{0.92}{CCB two-arm geometry schematic (SIM_CONFIG). Distances/angles (109 cm, -38°, +71.5°) and bar counts (8 B, 4 A) are Geant4 configuration values, not survey-grade metrology. A source-bound hardware survey is required for publication claims.}{SIM_CONFIG; see publication/tables/hardware_bom.csv and issue \\#1296.}
