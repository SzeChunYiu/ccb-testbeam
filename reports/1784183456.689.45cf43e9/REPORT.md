# S43a: trapezoid-template versus neural pulse-shape timing phase study

**Ticket:** `1784183456.689.45cf43e9`  
...
**1.339 ns** and 95% run-bootstrap CI
[1.234, 1.426] ns.
...
| gradient_boosted_trees | max_iter=160                          | 0.8873                    |
| mlp                    | hidden=[64, 32]                       | 0.9214                    |
| cnn_1d                 | epochs=4                              |                           |
| shape_residual_fusion  | 0.45 HGB + 0.35 ExtraTrees + 0.20 CNN | 0.5129                    |
...
| ---------------------- | ----------------- | --------------------- | ---------------------- | ------------------ | ------------------- | ----------------- | ---------------------- |
| shape_residual_fusion  | 1.339             | 1.234                 | 1.426                  | 1.574              | -2.385              | 0                 | 0                      |
| gradient_boosted_trees | 1.376             | 1.245                 | 1.476                  | 1.582              | -1.578              | 0                 | 0                      |
...
| ---------------------- | ------------ | ------------ | ----------- | ---------------- | ----------------- | ------ | ------- |
| shape_residual_fusion  | low_dE_proxy | 0            | mild_pileup | 90               | 0.978             | 0.8459 | 1.298   |
| gradient_boosted_trees | low_dE_proxy | 0            | mild_pileup | 90               | 0.9921            | 0.9188 | 1.271   |
| cnn_1d                 | low_dE_proxy | 0            | mild_pileup | 90               | 1.045             | 0.7419 | 1.241   |
| mlp                    | low_dE_proxy | 0            | mild_pileup | 90               | 1.153             | 0.8919 | 1.197   |
| shape_residual_fusion  | mid_dE_proxy | 0            | mild_pileup | 297              | 1.331             | 1.204  | 1.516   |
| gradient_boosted_trees | mid_dE_proxy | 0            | mild_pileup | 297              | 1.363             | 1.121  | 1.528   |
