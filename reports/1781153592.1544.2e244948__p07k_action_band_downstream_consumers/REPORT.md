...
**Ticket:** `1781153592.1544.2e244948`  
...
**Config:** `configs/p07k_1781153592_1544_2e244948_action_band_downstream_consumers.json`  
**Git commit:** `445096c8915439260464947381175ae25b37b211`
...
```bash
/home/billy/anaconda3/bin/python scripts/p07k_1781153592_1544_2e244948_action_band_downstream_consumers.py --config configs/p07k_1781153592_1544_2e244948_action_band_downstream_consumers.json
```
...
| consumer | winning method | primary estimate [95% CI] | supporting proxy | interpretation |
|---|---:|---:|---:|---|
| timing | traditional_run_family_duplicate_gate | timing_tail_delta = +0.000000 [+0.000000, +0.000000] | median_abs_cfd20_shift_ns = 0.000000 | No measurable timing-tail propagation. |
| PID | traditional_run_family_duplicate_gate | harm_rate_vs_no_correction = 0.000000 [0.000000, 0.000000] | precision = 0.8145 | Lowest downstream side-effect risk while preserving support labels. |
| q_template | traditional_run_family_duplicate_gate | q_template_median_shift = +0.000000 [+0.000000, +0.000000] | calibration_coverage = 1.0000 | Retained-template median remains unchanged. |
| energy | traditional_run_family_duplicate_gate | charge_bias = +0.013843 [+0.013388, +0.014283] | charge_res68 = 0.015407 | Charge/energy proxy remains bounded with complete calibration coverage. |
