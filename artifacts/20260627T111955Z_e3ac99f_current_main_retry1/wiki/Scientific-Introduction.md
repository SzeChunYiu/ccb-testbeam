...
This wiki draft introduces the CCB testbeam MC validation status for run `20260627T111955Z_e3ac99f_current_main_retry1`. The goal is to compare frozen MC validation artifacts against detector-analysis questions while keeping production, fixture, blocked, and release states distinct.
