# P07: Saturation Recovery for High-B2

## Abstract

Ticket `2402` asks for a raw-ROOT reproduction followed by an academic-grade
comparison of energy reconstruction under clipped saturation and unresolved
pile-up.  The worker is `testbeam-laptop-3`. The required single claim command was run once; because the local wrapper returned a null pseudo-ticket while the queue was non-empty, issue #2402 was recovered by applying the same label swap directly with GitHub issue metadata.  The held-out winner written to `result.json`
is **`saturation_residual_fusion_new`**, selected by the registered composite score.  Its energy
residual sigma68 is `0.06488` with 95% run-block
bootstrap CI [`0.05924`,
`0.07546`], and its pile-up separation
sigma68 is `10.85` ns.

## Raw ROOT Reproduction Gate

Raw B-stack files are read from `/home/billy/ccb-data/data/extracted/sorted-b`.  For each ROOT file, the
`tree/hrd.sample` waveform branch is adapted to the legacy `HRDv` layout and reshaped to `(event, channel, sample)` with 18
...
| ---------------------------------------------- | ------------ | -------------------- | ----------------------- | ------------------------------ | ------------------------------- | ---------------------------- | ------------------------------- | ---------------- | ---------------- | ------------------------------- | -------------------- |
| saturation_residual_fusion_new                 | 0.1641       | -0.004503            | 0.06488                 | 0.05924                        | 0.07546                         | 10.85                        | 5.052                           | 0.3122           | 0.2122           | 0.05073                         | 0.05508              |
...
| 1d_cnn                                         | 0.258        | -0.00477             | 0.1093                  | 0.09569                        | 0.1149                          | 18.02                        | 9.525                           | 0.2659           | 0.278            | 0.01139                         | 0.118                |
| tiny_sequence_transformer                      | 0.2658       | -0.04065             | 0.09466                 | 0.07597                        | 0.1057                          | 18.78                        | 10.91                           | 0.4512           | 0.1756           | 0.07489                         | 0.0863               |

The traditional comparator has score `0.2526` and energy
sigma68 `0.0897`.  The selected winner changes
energy sigma68 by `-0.02482`.
...
| ---------------------------------------------- | ----------------------- | ------------------------------ | ------------------------------- | ------------------------------- | ---------------------------- | ----------------------------------- | ------------------------------------ | ---------------------------- | ------------------------------- | -------------------- | --------------------- |
| saturation_residual_fusion_new                 | 0.06488                 | 0.05924                        | 0.07546                         | 0.06302                         | 10.85                        | 9.436                               | 12.32                                | 0.7136                       | 0.05073                         | 0.05508              | 0.3167                |
...
| tiny_sequence_transformer                      | 0.09466                 | 0.07597                        | 0.1057                          | 0.04817                         | 18.78                        | 16.58                               | 21.85                                | -3.345                       | 0.07489                         | 0.0863               | 0.1586                |
| 1d_cnn                                         | 0.1093                  | 0.09569                        | 0.1149                          | 0.08671                         | 18.02                        | 16.39                               | 19.65                                | -1.735                       | 0.01139                         | 0.118                | 0.1238                |
...
| ---------------------------------------------- | ----------- | ---------------------- | ------------------------- | ------------ | --------------- | ---------------- | ---------------- |
| 1d_cnn                                         | 58          | -0.01344               | 0.1295                    | -4.549       | 10.89           | 0.2927           | 0.3293           |
| 1d_cnn                                         | 60          | 0.02781                | 0.0908                    | -0.003917    | 12.83           | 0.2439           | 0.3293           |
| 1d_cnn                                         | 62          | -0.01344               | 0.08629                   | -1.984       | 11.63           | 0.2683           | 0.3293           |
| 1d_cnn                                         | 64          | 0.001137               | 0.1031                    | -2.668       | 11.23           | 0.2073           | 0.1463           |
| 1d_cnn                                         | 65          | -0.01977               | 0.09854                   | -4.189       | 11.95           | 0.3171           | 0.2561           |
...
| saturation_residual_fusion_new                 | 58          | 0.01526                | 0.06173                   | -0.8247      | 5.938           | 0.3293           | 0.2561           |
| saturation_residual_fusion_new                 | 60          | 0.001657               | 0.05979                   | 0.3464       | 6.304           | 0.2561           | 0.2805           |
| saturation_residual_fusion_new                 | 62          | -0.02008               | 0.05582                   | 0.464        | 8.415           | 0.3415           | 0.1829           |
| saturation_residual_fusion_new                 | 64          | -0.007676              | 0.0721                    | -1.133       | 6.771           | 0.3049           | 0.122            |
| saturation_residual_fusion_new                 | 65          | -0.003532              | 0.08051                   | -0.7528      | 7.06            | 0.3293           | 0.2195           |
| tiny_sequence_transformer                      | 58          | -0.03466               | 0.1085                    | -6.74        | 15.99           | 0.3902           | 0.2317           |
| tiny_sequence_transformer                      | 60          | -0.02917               | 0.1038                    | -5.146       | 13.7            | 0.3902           | 0.2439           |
| tiny_sequence_transformer                      | 62          | -0.0361                | 0.0683                    | -7.03        | 13.97           | 0.5366           | 0.1341           |
| tiny_sequence_transformer                      | 64          | -0.04441               | 0.09834                   | -9.375       | 14.26           | 0.4268           | 0.09756          |
| tiny_sequence_transformer                      | 65          | -0.06125               | 0.08392                   | -8.939       | 15.3            | 0.5122           | 0.1707           |
...
| -------------- | -------------- | ---------------------------------------------- | ---------------------- | ------------------------- | ------------ | --------------- | ---------------- |
| spacing_bin    | (-0.001, 10.0] | 1d_cnn                                         | 0.0257                 | 0.09405                   | 1.687        | 12.72           | 0.3617           |
| spacing_bin    | (10.0, 25.0]   | 1d_cnn                                         | 0.0153                 | 0.105                     | -2.669       | 7.467           | 0.3111           |
| spacing_bin    | (25.0, 45.0]   | 1d_cnn                                         | -0.01136               | 0.09726                   | -6.494       | 9.784           | 0.1959           |
| spacing_bin    | (45.0, 70.0]   | 1d_cnn                                         | -0.05163               | 0.09081                   | -3.565       | 17              | 0.1341           |
...
| spacing_bin    | (-0.001, 10.0] | saturation_residual_fusion_new                 | 0.01526                | 0.05567                   | 0.5902       | 6.937           | 0.4113           |
| spacing_bin    | (10.0, 25.0]   | saturation_residual_fusion_new                 | 0.01519                | 0.05646                   | 0.7238       | 5.408           | 0.3556           |
| spacing_bin    | (25.0, 45.0]   | saturation_residual_fusion_new                 | -0.01362               | 0.06289                   | -2.19        | 7.405           | 0.2577           |
| spacing_bin    | (45.0, 70.0]   | saturation_residual_fusion_new                 | -0.03171               | 0.06968                   | -1.535       | 8.557           | 0.1585           |
| spacing_bin    | (-0.001, 10.0] | tiny_sequence_transformer                      | -0.003157              | 0.0804                    | -5.025       | 11.18           | 0.5532           |
| spacing_bin    | (10.0, 25.0]   | tiny_sequence_transformer                      | -0.01248               | 0.07933                   | -9.685       | 8.602           | 0.5778           |
| spacing_bin    | (25.0, 45.0]   | tiny_sequence_transformer                      | -0.04065               | 0.07992                   | -11.67       | 16.66           | 0.3711           |
| spacing_bin    | (45.0, 70.0]   | tiny_sequence_transformer                      | -0.1048                | 0.0786                    | -5.224       | 16.94           | 0.2317           |
| ratio_bin      | (-0.001, 0.35] | 1d_cnn                                         | 0.01681                | 0.1212                    | -7.864       | 11.78           | 0.4444           |
| ratio_bin      | (0.35, 0.625]  | 1d_cnn                                         | -0.02844               | 0.08862                   | -3.254       | 10.73           | 0.2736           |
| ratio_bin      | (0.625, 0.875] | 1d_cnn                                         | -0.008498              | 0.09001                   | -2.572       | 11.46           | 0.2079           |
| ratio_bin      | (0.875, 1.05]  | 1d_cnn                                         | 0.02067                | 0.1103                    | -1.22        | 11.95           | 0.1681           |
...
| ratio_bin      | (-0.001, 0.35] | saturation_residual_fusion_new                 | 0.01768                | 0.06511                   | -2.463       | 7.503           | 0.5111           |
| ratio_bin      | (0.35, 0.625]  | saturation_residual_fusion_new                 | -0.01543               | 0.07044                   | -1.422       | 7.842           | 0.3679           |
| ratio_bin      | (0.625, 0.875] | saturation_residual_fusion_new                 | -0.00281               | 0.05934                   | -0.2285      | 7.125           | 0.2277           |
| ratio_bin      | (0.875, 1.05]  | saturation_residual_fusion_new                 | -0.00834               | 0.0655                    | 0.9762       | 6.687           | 0.177            |
| ratio_bin      | (-0.001, 0.35] | tiny_sequence_transformer                      | -0.005024              | 0.08861                   | -10.52       | 18.39           | 0.5444           |
| ratio_bin      | (0.35, 0.625]  | tiny_sequence_transformer                      | -0.04619               | 0.1039                    | -9.645       | 15.55           | 0.4528           |
| ratio_bin      | (0.625, 0.875] | tiny_sequence_transformer                      | -0.04575               | 0.09699                   | -7.177       | 10.68           | 0.4653           |
| ratio_bin      | (0.875, 1.05]  | tiny_sequence_transformer                      | -0.03495               | 0.0779                    | -5.345       | 13.18           | 0.3628           |
| saturation_bin | 0              | 1d_cnn                                         | -0.003561              | 0.1098                    | -2.992       | 11.51           | 0.2732           |
| saturation_bin | 1-2            | 1d_cnn                                         | -0.1118                | 0.05851                   | -10.35       | 15.4            | 0                |
| saturation_bin | 3-5            | 1d_cnn                                         | -0.04054               | 0.05778                   | 3.666        | 15.31           | 0                |
| saturation_bin | 6+             | 1d_cnn                                         | 0.02545                | 0                         | 18.62        | 11.1            | 0                |
...
| saturation_bin | 0              | saturation_residual_fusion_new                 | -0.003558              | 0.06468                   | -0.1672      | 7.034           | 0.3208           |
| saturation_bin | 1-2            | saturation_residual_fusion_new                 | -0.04109               | 0.04332                   | -7.448       | 8.012           | 0                |
| saturation_bin | 3-5            | saturation_residual_fusion_new                 | -0.007421              | 0.05294                   | -2.409       | 5.574           | 0                |
| saturation_bin | 6+             | saturation_residual_fusion_new                 | 0.09641                | 0                         | 5.46         | 5.895           | 0                |
| saturation_bin | 0              | tiny_sequence_transformer                      | -0.03942               | 0.09229                   | -7.271       | 14.89           | 0.4612           |
| saturation_bin | 1-2            | tiny_sequence_transformer                      | -0.1645                | 0.04636                   | -10.34       | 10.36           | 0.25             |
| saturation_bin | 3-5            | tiny_sequence_transformer                      | -0.1683                | 0.0564                    | -6.507       | 7.52            | 0                |
| saturation_bin | 6+             | tiny_sequence_transformer                      | -0.1435                | 0                         | -0.655       | 14.65           | 0                |
| pedestal_state | nominal        | 1d_cnn                                         | -0.02289               | 0.07299                   | -0.7253      | 10.52           | 0.2449           |
| pedestal_state | shifted        | 1d_cnn                                         | 0.0153                 | 0.1375                    | -4.512       | 12.37           | 0.2776           |
...
`result.json` names **saturation_residual_fusion_new** as the P07 winner.  The traditional clipped
...
Runtime was `87.9` s on `Linux-5.15.0-139-generic-x86_64-with-glibc2.35`.
