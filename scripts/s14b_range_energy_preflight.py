...
def main() -> None:
    ...
    finding = (
        ...
        "but it is not an absolute energy calibration: Birks quenching, material budget, and external particle truth remain unresolved."
    )
    ...
    manifest = {
        ...
        "command": "/home/billy/anaconda3/bin/python scripts/s14b_range_energy_preflight.py --config configs/s14b_range_energy_preflight.yaml",
