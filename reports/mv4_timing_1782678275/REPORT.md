...
- status: **PRODUCTION**
- generated: 2026-06-28T20:24:49.883535+00:00
...
## MC verdict
- Raw CFD20 resolution **reproduces data** (MC 1.74 vs S02 1.85 ns, pull -1.05); overall **REVIEW**.
- The MC shows **little amplitude timewalk** (correction 0.99x vs data 1.23x): with an ideal fractional CFD the leading-edge time is nearly amplitude-independent, so there is little walk to remove. The data's larger S02->S03 gain points to walk sources absent from this toy (real pulse-shape variation, baseline restoration, discrete-threshold electronics) -- hence the corrected-stage TENSION, while the raw resolution agrees.
