...
- **Study ID:** S00c
- **Ticket:** 1781006678.1296.6b406328
...
## 3. ML Method
The ML method is a logistic classifier trained to predict the median-first-four selector from raw waveform summaries. The split is by run, with runs 57, 65 held out. Cross-validation on training runs is grouped by run, and the accuracy intervals below bootstrap the held-out runs, not individual records.
...
| dynamic-range selector              |   0.985446 |          0.976354 |           0.99285  |             4058 |                0 | intentional semantic-change comparator                  |
| ML logistic honest raw summaries    |   0.99773  |          0.997716 |           0.997746 |              554 |               79 | run-group CV selected C=10.0                            |
| ML leakage sentinel with median_amp |   0.999788 |          0.999733 |           0.999856 |               59 |                0 | contains a direct monotone transform of the target rule |
