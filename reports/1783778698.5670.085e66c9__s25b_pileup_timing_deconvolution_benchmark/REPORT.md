...
B-stack HRD waveforms.  The ticket was `1783778698.5670.085e66c9` and the worker was
...
`gradient_boosted_trees`, with held-out run-block sigma68 `7.81` ns
and 95% bootstrap interval [6.98,
8.47] ns.
...
|:--------------------------------|---------------:|------------------:|-------------------------:|--------------------------:|-----------------------------:|-------------------:|-------------------:|----------------------------:|
| gradient_boosted_trees          |        -1.369  |             7.807 |                    6.975 |                     8.465 |                       0.1048 |             0.3    |             0.1867 |                     0.06021 |
...
winner `gradient_boosted_trees` changes that by `-1.69`
...
| spacing_bin     | (25.0, 45.0]   | causal_transformer_new          |      -2.45     |             6.43  |             0.1972 |                     0.07717 |
...
Runtime was `120.4` s on `Linux-5.15.0-139-generic-x86_64-with-debian-bullseye-sid`.
