...
**2026-07-04:** the post-review correction program (Phases 0–4 + statistics hardening) is complete; see [`FINDINGS_SYNTHESIS.md`](FINDINGS_SYNTHESIS.md) "Post-review program (2026-07-03/04)" for what changed (MV3 re-graded TENSION with the trigger as root cause, C12 ruled out, honest two-pulse benchmark, independent MC live-time, FDR census).
...
| Anomaly identity | **NOT C12 recoils** — 4.4% early-peak class is instrumental/trigger-phase (data-side question) | ✅ C12 ruled out (MV6b, 2026-07-04: 0/1,656 quenched C12 records pass A>1000 at any gain) |
