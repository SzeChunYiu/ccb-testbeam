# S24a: saturation-aware pulse-morphology energy reconstruction

## Abstract

This study anchors the B-stave ADC-to-MeV conversion to hibeam_g4 `Sci_bar_EDep` truth from the high-statistics GEANT4 ROOT tree, then benchmarks a strong Birks/duplicate-readout traditional calibration against ridge regression, gradient-boosted trees, a tabular MLP, a 1D-CNN, a compact waveform transformer, and a Birks-residual MLP. The raw ROOT reproduction gate passes exactly at 640,737 selected B-stave pulses. The held-out winner is **geant4_birks_lookup** with res68=0.04024 and run-block bootstrap 95% CI [0.03886, 0.04161].
...
All learned models use the same train/held-out split by run. Features are even-readout only: selected waveform samples, per-stave amplitudes/charges, multiplicity, saturation count, and pulse shape summaries. Odd charges, event identifiers, and run labels are excluded from model inputs. The panel is ridge regression, gradient-boosted trees, a tabular MLP, a small 1D-CNN over the four B-stave waveforms, a compact transformer encoder over the eighteen waveform time samples, and a new truth-Birks residual MLP that predicts a multiplicative correction to the traditional baseline.
...
| transformer            | neural_waveform_attention | 332852 | 0.032605  | 0.12644    | [0.12036696496072326, 0.14397723058115808]  | 1.9291  | [1.8155777673132256, 2.028701643452403]  |
...
| old_power_law          | traditional_empirical     | 332852 | -0.29763  | 0.46236    | [0.44430944738067446, 0.5643754008880238]   | 7.8628  | [7.4234201643915005, 8.245179360311488]  |
...
| 60  | old_power_law       | 10133 | -0.0023041 | 0.84569    | 9.2926  |
...
| --- | --- | --- | --- | --- | --- | --- |
| [0.038, 8.472)   | old_power_law       | 66571 | 4.5472                  | 2.0154     | 3.1668     | [2.905591114137602, 3.4833638768620694]     |
| [0.038, 8.472)   | geant4_birks_lookup | 66571 | 4.5472                  | -0.0052365 | 0.17364    | [0.05237051835870767, 0.342213748596141]    |
| [8.472, 16.885)  | old_power_law       | 66566 | 12.929                  | 0.060522   | 0.21103    | [0.1956170007969685, 0.23004922234031763]   |
| [8.472, 16.885)  | geant4_birks_lookup | 66566 | 12.929                  | -0.017648  | 0.027196   | [0.02630567887833759, 0.0283626631408768]   |
| [16.885, 21.297) | old_power_law       | 66574 | 19.522                  | -0.29763   | 0.32152    | [0.31545085450744625, 0.3245458435814357]   |
| [16.885, 21.297) | geant4_birks_lookup | 66574 | 19.522                  | -0.029958  | 0.034235   | [0.03338068104986673, 0.0356029738304443]   |
| [21.297, 24.077) | old_power_law       | 66568 | 22.752                  | -0.39733   | 0.41001    | [0.4084209169059069, 0.4109371420971099]    |
| [21.297, 24.077) | geant4_birks_lookup | 66568 | 22.752                  | -0.035429  | 0.04117    | [0.04040323640107637, 0.04314388269000952]  |
| [24.077, 76.126] | old_power_law       | 66573 | 25.488                  | -0.46203   | 0.47647    | [0.4707948127667473, 0.49794932820496585]   |
| [24.077, 76.126] | geant4_birks_lookup | 66573 | 25.488                  | -0.043291  | 0.051248   | [0.050483314775519664, 0.05193229526978251] |

## Saturation and Pulse-Morphology Stress Tests

The ticket-specific stress table repeats the held-out run-block bootstrap inside ADC-saturation, multi-hit pile-up, pedestal-drift proxy, and late/deep pulse-shape strata. The pedestal proxy is the event charge-to-peak ratio, which is sensitive to broad baseline excursions under the same raw-waveform decoding used for the reproduction count.

| stratum                   | subset     | method              | n      | bias_frac | res68_frac | res68_ci95                                  | mae_mev |
| --- | --- | --- | --- | --- | --- | --- | --- |
| adc_saturation_onset      | in_stratum | geant4_birks_lookup | 106217 | -0.040403 | 0.048498   | [0.04744534451871076, 0.05114720164608243]  | 1.2846  |
| adc_saturation_onset      | in_stratum | 1d_cnn              | 106217 | -0.16048  | 0.18976    | [0.1809644808514061, 0.19880711123036537]   | 4.2672  |
| adc_saturation_onset      | in_stratum | transformer         | 106217 | 0.075446  | 0.096004   | [0.09198734107417024, 0.10442983802208876]  | 2.226   |
| adc_saturation_onset      | complement | geant4_birks_lookup | 226635 | -0.016697 | 0.033521   | [0.032764224604618385, 0.03476465449711962] | 0.9877  |
| adc_saturation_onset      | complement | 1d_cnn              | 226635 | -0.19794  | 0.2966     | [0.2831725629371853, 0.3267713560828257]    | 3.6723  |
| adc_saturation_onset      | complement | transformer         | 226635 | -0.068469 | 0.14101    | [0.13441547111225227, 0.15897941050335268]  | 1.79    |
| pileup_or_multihit        | in_stratum | geant4_birks_lookup | 27765  | -0.019433 | 0.12595    | [0.1095536528163852, 0.14222525774097294]   | 3.1683  |
| pileup_or_multihit        | in_stratum | 1d_cnn              | 27765  | 0.016856  | 0.42682    | [0.422897693841899, 0.43316400606341016]    | 8.0801  |
| pileup_or_multihit        | in_stratum | transformer         | 27765  | 0.0077664 | 0.26183    | [0.25763666467369345, 0.26990773337908164]  | 4.2135  |
| pileup_or_multihit        | complement | geant4_birks_lookup | 305087 | -0.02362  | 0.03914    | [0.03761871415330434, 0.04033562694130592]  | 0.89261 |
| pileup_or_multihit        | complement | 1d_cnn              | 305087 | -0.17995  | 0.25207    | [0.23876221252385513, 0.27352140971105476]  | 3.4782  |
| pileup_or_multihit        | complement | transformer         | 305087 | 0.034528  | 0.12239    | [0.11850433684169161, 0.13283881058129418]  | 1.7212  |
| pedestal_drift_proxy_high | in_stratum | geant4_birks_lookup | 166426 | -0.023258 | 0.033216   | [0.03250552055848135, 0.03443589382330298]  | 1.1235  |
| pedestal_drift_proxy_high | in_stratum | 1d_cnn              | 166426 | -0.2061   | 0.27378    | [0.26298178997286864, 0.28614125304740706]  | 4.4533  |
| pedestal_drift_proxy_high | in_stratum | transformer         | 166426 | -0.09006  | 0.12487    | [0.11978640610636017, 0.12878485633983405]  | 2.2479  |
| pedestal_drift_proxy_high | complement | geant4_birks_lookup | 166426 | -0.02208  | 0.048584   | [0.04742438981489519, 0.05024996920947048]  | 1.0414  |
| pedestal_drift_proxy_high | complement | 1d_cnn              | 166426 | -0.14653  | 0.24641    | [0.22278897230443612, 0.29567803634622436]  | 3.2709  |
| pedestal_drift_proxy_high | complement | transformer         | 166426 | 0.080079  | 0.13177    | [0.11111230801689947, 0.18504521481171518]  | 1.6103  |
| late_pulse_shape          | in_stratum | geant4_birks_lookup | 15256  | -0.017026 | 0.11667    | [0.1032258569598724, 0.1314933072410294]    | 3.0832  |
| late_pulse_shape          | in_stratum | 1d_cnn              | 15256  | 0.29179   | 0.51866    | [0.4931733600526049, 0.5514586392306028]    | 7.854   |
| late_pulse_shape          | in_stratum | transformer         | 15256  | 0.056415  | 0.2613     | [0.24035274751102587, 0.29002631722801936]  | 3.9154  |
| late_pulse_shape          | complement | geant4_birks_lookup | 317596 | -0.02365  | 0.039799   | [0.03841009716921187, 0.04110813624084088]  | 0.98633 |
| late_pulse_shape          | complement | 1d_cnn              | 317596 | -0.18301  | 0.26018    | [0.2423484412306757, 0.28309370353145186]   | 3.6704  |
| late_pulse_shape          | complement | transformer         | 317596 | 0.031359  | 0.12469    | [0.11914835537330555, 0.136980728555582]    | 1.8337  |
...
| old_power_law          | 0.46236               | 0.46232                   | 3.4069e-05       | -2.4094e-05     |
| mlp                    | 0.69235               | 0.18327                   | 0.50907          | -0.60328        |

## Leakage, Systematics, and Caveats Checks
