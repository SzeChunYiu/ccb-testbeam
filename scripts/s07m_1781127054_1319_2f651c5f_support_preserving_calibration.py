...
the label is injected truth rather than a D_t threshold. The S07m question is
...
def write_report(
    ...
    text = f"""# S07m: support-preserving injected-morphology calibration
...
def main() -> int:
    ...
    parser.add_argument("--config", default="configs/s07m_1781127054_1319_2f651c5f_support_preserving_calibration.json")
    ...
    manifest = {
        ...
        "command": f"scripts/s07m_1781127054_1319_2f651c5f_support_preserving_calibration.py --config {config_path}",
