...
\PaperFigure{figures/final/stave_geometry.pdf}{0.88}{B-stack stave geometry (DESIGN_SPEC per issue \#796). Dimensions: 50 cm × 5.18 cm × 2.0 cm (L×W×H); two 2.0 mm longitudinal holes at 2.0 cm spacing; 1.8 mm Kuraray Y-11 fibres; one-fibre one-end readout. Source-bound hardware drawing/BOM required for publication metrology.}{DESIGN_SPEC; see publication/tables/hardware_bom.csv and issue \#1296.}
