...
This wiki draft introduces the CCB testbeam MC validation status for run `20260627T180424Z_2516606_mv4_timing_final`. The goal is to compare frozen MC validation artifacts against detector-analysis questions while keeping production, fixture, blocked, and release states distinct.
