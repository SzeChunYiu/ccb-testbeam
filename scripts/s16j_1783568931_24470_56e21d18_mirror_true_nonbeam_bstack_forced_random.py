#!/usr/bin/env python3
"""S16j direct forced/random pedestal ROOT audit and hidden-mode bakeoff.
...
os.environ.setdefault("MPLCONFIGDIR", "/tmp/s16j_1783568931_mplconfig")
...
S16K = load_module(S16K_PATH, "s16k_for_s16j_direct_truth_audit")
...
def write_report(config: dict, outdir: Path, reproduction: pd.DataFrame, audit: pd.DataFrame, summary: pd.DataFrame, per_run: pd.DataFrame, deltas: pd.DataFrame, winner: dict, inputs: pd.DataFrame) -> None:
    ...
    report = f"""# S16j: DAQ-provenanced B-stack forced/random pedestal ROOT audit
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/s16j_1783568931_24470_56e21d18_mirror_true_nonbeam_bstack_forced_random.json")
            ...
            json_ready(
                {
                    ...
                    "command": "/home/billy/anaconda3/bin/python scripts/s16j_1783568931_24470_56e21d18_mirror_true_nonbeam_bstack_forced_random.py --config configs/s16j_1783568931_24470_56e21d18_mirror_true_nonbeam_bstack_forced_random.json",
                }
            ),
            indent=2,
        )
