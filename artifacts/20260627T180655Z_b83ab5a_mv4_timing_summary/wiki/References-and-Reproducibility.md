...
```bash
python scripts/mc_validation/run_pipeline.py --run-id 20260627T180655Z_b83ab5a_mv4_timing_summary release
python scripts/mc_validation/run_pipeline.py --run-id 20260627T180655Z_b83ab5a_mv4_timing_summary qa
```
