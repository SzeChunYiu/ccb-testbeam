...
```bash
python scripts/mc_validation/run_pipeline.py --run-id 20260627T113254Z_8e7d78d_wrapper_release_retry release
python scripts/mc_validation/run_pipeline.py --run-id 20260627T113254Z_8e7d78d_wrapper_release_retry qa
```
