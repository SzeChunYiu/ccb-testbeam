...
Ticket `2425` asks for a raw-ROOT reproduction followed by an academic-grade
...
The information-boundary winner minimizes
...
The stratum scan maps the observable information boundary across saturation depth, pile-up spacing, amplitude ratio, injected-noise morphology,
...
`result.json` names **saturation_residual_fusion_new** as the S45b winner.  The traditional clipped
...
Runtime was `77.8` s on `Linux-5.15.0-139-generic-x86_64-with-debian-bullseye-sid`.
