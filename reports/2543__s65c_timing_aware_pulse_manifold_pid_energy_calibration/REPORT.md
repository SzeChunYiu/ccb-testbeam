...
**Raw ROOT directory:** `/home/billy/.tb-workers/testbeam-laptop-4/data/root/root`
...
and saturation move the joint PID-energy calibration surface.  The raw selected-pulse
...
saturation, and pedestal truth proxies.  This S65c runner does not refit those
...
pile-up flags before applying class-conditional likelihoods.  With standardized charge-depth variables `z_j` and PID
class `y`,
...
Use **`template_residual_boosted_stack_new`** as the S65c benchmark winner.  The result favors a hybrid
