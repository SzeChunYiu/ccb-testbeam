# S55b: Saturation Pile-Up Energy Recovery Benchmark

## Abstract

Ticket `2494` asks for a raw-ROOT reproduction followed by an academic-grade
comparison of energy reconstruction under clipped saturation and unresolved
pile-up.  The worker is `testbeam-laptop-2`.  The held-out winner written to `result.json`
...
| ---------------------------------------------- | ------------ | -------------------- | ----------------------- | ------------------------------ | ------------------------------- | ---------------------------- | ------------------------------- | ---------------- | ---------------- | ------------------------------- | -------------------- | ------------- | ------------- |
| saturation_residual_fusion_new                 | 0.1643       | -0.006657            | 0.06564                 | 0.05659                        | 0.07611                         | 10.63                        | 5.499                           | 0.3024           | 0.2024           | 0.03504                         | 0.04649              | 0.9929        | 0.01648       |
| gradient_boosted_trees                         | 0.1707       | -0.00195             | 0.06985                 | 0.06123                        | 0.07663                         | 10.87                        | 5.065                           | 0.3098           | 0.2293           | 0.04706                         | 0.0619               | 0.9926        | 0.01646       |
| ridge                                          | 0.1863       | -0.002334            | 0.06947                 | 0.06457                        | 0.07491                         | 14.01                        | 6.28                            | 0.3049           | 0.1951           | 0.04402                         | 0.0684               | 0.9938        | 0.02109       |
| mlp                                            | 0.2239       | -0.007954            | 0.08241                 | 0.06816                        | 0.09264                         | 16.21                        | 7.735                           | 0.3171           | 0.2244           | 0.1429                          | 0.05224              | 0.9901        | 0.02161       |
| 1d_cnn                                         | 0.2626       | -0.01612             | 0.1115                  | 0.09768                        | 0.1213                          | 17.37                        | 9.226                           | 0.2732           | 0.2707           | 0.04111                         | 0.1139               | 0.9823        | 0.02651       |
| tiny_sequence_transformer                      | 0.2719       | -0.03442             | 0.0971                  | 0.0805                         | 0.1058                          | 19.16                        | 11.1                            | 0.4463           | 0.1756           | 0.07489                         | 0.09686              | 0.9857        | 0.03177       |
| analytic_clipped_template_sideband_traditional | 0.2806       | 0.06213              | 0.0897                  | 0.08117                        | 0.1072                          | 16                           | 8.241                           | 0.5829           | 0.1878           | 0.1026                          | 0.0844               | 0.7266        | 0.3961        |

The traditional comparator has score `0.2806` and energy
...
| method                                         | pid_proxy_auc | pid_proxy_auc_ci_low | pid_proxy_auc_ci_high | pid_proxy_ece | pid_proxy_ece_ci_low | pid_proxy_ece_ci_high | pid_positive_rate |
| ---------------------------------------------- | ------------- | -------------------- | --------------------- | ------------- | -------------------- | --------------------- | ----------------- |
| ridge                                          | 0.9938        | 0.9906               | 0.997                 | 0.02109       | 0.01685              | 0.02648               | 0.05122           |
| saturation_residual_fusion_new                 | 0.9929        | 0.9868               | 0.9977                | 0.01648       | 0.01266              | 0.02218               | 0.05122           |
| gradient_boosted_trees                         | 0.9926        | 0.9874               | 0.9971                | 0.01646       | 0.01439              | 0.0216                | 0.05122           |
| mlp                                            | 0.9901        | 0.984                | 0.996                 | 0.02161       | 0.01643              | 0.02924               | 0.05122           |
| tiny_sequence_transformer                      | 0.9857        | 0.9692               | 0.9955                | 0.03177       | 0.03006              | 0.03746               | 0.05122           |
| 1d_cnn                                         | 0.9823        | 0.9759               | 0.9898                | 0.02651       | 0.02186              | 0.03977               | 0.05122           |
| analytic_clipped_template_sideband_traditional | 0.7266        | 0.6637               | 0.7819                | 0.3961        | 0.3826               | 0.4119                | 0.05122           |
...
`result.json` names **saturation_residual_fusion_new** as the S55b winner.  The traditional clipped
...
Runtime was `80.0` s on `Linux-5.15.0-139-generic-x86_64-with-glibc2.29`.
