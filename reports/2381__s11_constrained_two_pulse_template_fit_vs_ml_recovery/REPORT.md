...
and timing on injected pile-up.  The worker is `testbeam-laptop-3`.  The
...
Use `saturation_residual_fusion_new` as the preferred S11 controlled-overlay energy-closure method
