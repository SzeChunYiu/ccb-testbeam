...
\PaperFigure{figures/illustrative/geometry_tof.png}{0.92}{CCB two-arm geometry schematic. The current package treats this as illustrative/configuration evidence, not survey metrology.}{ILLUSTRATIVE; source-bound survey figure still required.}
