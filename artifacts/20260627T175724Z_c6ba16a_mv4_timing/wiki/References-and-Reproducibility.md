...
```bash
python scripts/mc_validation/run_pipeline.py --run-id 20260627T175724Z_c6ba16a_mv4_timing release
python scripts/mc_validation/run_pipeline.py --run-id 20260627T175724Z_c6ba16a_mv4_timing qa
```
