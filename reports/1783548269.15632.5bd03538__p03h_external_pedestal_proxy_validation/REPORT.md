# P03h: external pedestal-proxy validation for residualized early waveform samples

- **Ticket:** `1783548269.15632.5bd03538`
- **Worker:** `testbeam-laptop-2`
- **Claimed study:** train-fold external pedestal-proxy validation for residualized early waveform samples
...
- **External pedestal-proxy validation:** `4` train-fold strata per held-out run
...
|   sample |   external_r2 |   external_original_std |   external_residual_std |
|---------:|--------------:|------------------------:|------------------------:|
|        0 |      0.906119 |               0.0921484 |              0.0110779  |
|        1 |     -1.82255  |               0.0439498 |              0.0250112  |
|        2 |     -2.37755  |               0.0449079 |              0.0198321  |
|        3 |      0.587144 |               0.0858891 |              0.00621223 |
