...
def generate_wiki_export(run_root: Path) -> dict[str, Any]:
    ...
    intro = "\n".join([
        ...
        "- `REF-PDG-RPP-2024` anchors particle/passage-through-matter vocabulary; any numerical efficiency, energy, or range claim must still cite frozen project artifacts.",
