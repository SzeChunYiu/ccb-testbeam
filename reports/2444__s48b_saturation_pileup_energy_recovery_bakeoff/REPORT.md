# S48b: Saturation and Pile-up Energy-Recovery Method Bakeoff

## Abstract

Ticket `2444` asks for an academic-grade comparison of a strong traditional
...
Use `saturation_residual_fusion_new` as the preferred S48b controlled-overlay energy-closure method
