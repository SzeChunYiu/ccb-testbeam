...
This wiki draft introduces the CCB testbeam MC validation status for run `20260627T175724Z_c6ba16a_mv4_timing`. The goal is to compare frozen MC validation artifacts against detector-analysis questions while keeping production, fixture, blocked, and release states distinct.
