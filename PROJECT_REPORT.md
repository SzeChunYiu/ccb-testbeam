...
| **Biggest open item** | Gain has **no precision value** (honest statement: ≈60–70 ADC/MeV, dominated by trigger/quenching modelling; quenched re-scan DONE 2026-07-05 (~65 measured)). Next MC-side work item: score `Trig_bar` volumes for a real trigger flag (closes the residual MV3 tension). Early-peak 4.4% class is a **data-side** question (C12 ruled out by MV6b). |
