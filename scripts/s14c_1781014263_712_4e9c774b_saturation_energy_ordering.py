...
def make_report(out_dir: Path, config: dict, result: dict, metrics: pd.DataFrame, geom: pd.DataFrame, by_run: pd.DataFrame, leakage: pd.DataFrame) -> None:
    ...
    lines = [
        ...
        "",
        "```bash",
        "/home/billy/anaconda3/bin/python scripts/s14c_1781014263_712_4e9c774b_saturation_energy_ordering.py --config configs/s14c_1781014263_712_4e9c774b.yaml",
        "```",
    ]
...
def main() -> None:
    ...
    parser.add_argument("--config", default="configs/s14c_1781014263_712_4e9c774b.yaml")
    ...
    manifest = {
        ...
        "command": "/home/billy/anaconda3/bin/python scripts/s14c_1781014263_712_4e9c774b_saturation_energy_ordering.py --config configs/s14c_1781014263_712_4e9c774b.yaml",
