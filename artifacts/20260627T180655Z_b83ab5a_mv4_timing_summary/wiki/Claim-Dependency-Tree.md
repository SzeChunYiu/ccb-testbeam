...
flowchart TD
    ...
    C_CLAIM_MV4_SUMMARY["CLAIM-MV4-SUMMARY (SUPPORTED)"]
    FINAL --> C_CLAIM_MV4_SUMMARY
    E_reports_mc_validation_summary_metrics_table_csv["reports/mc_validation/summary/metrics_table.csv"]
    C_CLAIM_MV4_SUMMARY --> E_reports_mc_validation_summary_metrics_table_csv
    R_REF_FINAL_BIBLIOGRAPHY_AUDIT["REF-FINAL-BIBLIOGRAPHY-AUDIT"]
    C_CLAIM_MV4_SUMMARY -. reference .-> R_REF_FINAL_BIBLIOGRAPHY_AUDIT
