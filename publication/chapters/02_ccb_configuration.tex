...
\PaperFigure{figures/illustrative/geometry_tof.png}{0.92}{CCB two-arm geometry schematic (SIM\_CONFIG). Distances/angles (109 cm, $-38^{\circ}$, $+71.5^{\circ}$) and bar counts (8 B, 4 A) are Geant4 configuration values, not survey-grade metrology. A source-bound hardware survey is required for publication claims.}{SIM\_CONFIG; see publication/tables/hardware\_bom.csv and issue \#1296.}
