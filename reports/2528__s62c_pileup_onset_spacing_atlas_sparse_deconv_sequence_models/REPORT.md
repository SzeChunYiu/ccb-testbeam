...
Ticket `2528` asks for a raw-ROOT reproduction followed by an academic-grade
...
sequence models, and a new residual-fusion architecture.  The worker is `testbeam-laptop-4`.  The held-out winner written to `result.json`
...
|:--------------------|:--------------------------------------------------|---------:|-----------:|------------:|:-------------------|
| pulse_shape         | matched-filter residual/pulse-shape closure proxy |  0.06488 |   0.05924  |     0.07546 | fractional sigma68 |
| hit_timing          | leading-edge hit timing shift                     |  5.052   |   4.549    |     5.981   | ns sigma68         |
| pileup_separation   | two-pulse spacing recovery                        | 10.85    |   9.436    |    12.32    | ns sigma68         |
| saturation_recovery | clipped-pulse energy recovery                     |  0.06302 |   0.01621  |     0.09009 | fractional sigma68 |
| pedestal_excursions | pedestal-state false-split span                   |  0.05073 |   0.005525 |     0.1168  | rate span          |
| energy_transfer     | total injected charge transfer                    |  0.06488 |   0.05924  |     0.07546 | fractional sigma68 |
| pid_stability       | stave/PID-proxy energy-bias span                  |  0.05508 |   0.03479  |     0.07224 | fractional span    |
...
| stratum          | value             |   energy_fractional_bias |   energy_fractional_sigma68 |   time_bias_ns |   time_sigma68_ns |   pileup_miss_rate |
|:-----------------|:------------------|-------------------------:|----------------------------:|---------------:|------------------:|-------------------:|
| saturation_bin   | 0                 |                -0.003558 |                     0.06468 |        -0.1672 |             7.034 |            0.3208  |
| saturation_bin   | 1-2               |                -0.04109  |                     0.04332 |        -7.448  |             8.012 |            0       |
| saturation_bin   | 3-5               |                -0.007421 |                     0.05294 |        -2.409  |             5.574 |            0       |
| saturation_bin   | 6+                |                 0.09641  |                     0       |         5.46   |             5.895 |            0       |
| pedestal_state   | nominal           |                -0.006919 |                     0.06075 |         0.2386 |             6.238 |            0.3265  |
| pedestal_state   | shifted           |                -0.0026   |                     0.06666 |        -0.6725 |             7.432 |            0.3042  |
| morphology_state | late_tail_high    |                -0.002518 |                     0.06371 |        -0.2578 |             6.957 |            0.3966  |
| morphology_state | late_tail_low     |                -0.006468 |                     0.06582 |        -0.4132 |             6.954 |            0.2468  |
| pid_proxy_class  | inner_high_charge |                -0.04096  |                     0.07511 |        -3.041  |             8.031 |            0.02564 |
| pid_proxy_class  | other             |                -0.00141  |                     0.06376 |         0.2717 |             6.851 |            0.3423  |
| stave            | B2                |                -0.03836  |                     0.07119 |        -3.742  |             8.583 |            0.386   |
| stave            | B4                |                 0.01672  |                     0.07231 |        -1.82   |             6.264 |            0.3394  |
| stave            | B6                |                 0.001457 |                     0.07042 |         1.21   |             5.818 |            0.3053  |
| stave            | B8                |                -0.002862 |                     0.06087 |         1.042  |             5.869 |            0.1957  |

## Ticket Claim Provenance

The required helper command `tn-ticket claim testbeam-laptop-4 --project testbeam` was run exactly once and returned the known null pseudo-ticket output (`null`, `# null`, `null`).  Direct queue inspection showed issue #2528 was still open, so the issue was manually label-swapped to `factory:claimed` and `worker:testbeam-laptop-4` without rerunning the helper.  No novel follow-up ticket was appended.
...
`result.json` names **saturation_residual_fusion_new** as the S62c winner.  The traditional clipped
...
Runtime was `104.5` s on `Linux-5.15.0-139-generic-x86_64-with-glibc2.35`.
