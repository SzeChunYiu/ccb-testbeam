...
keeps the claimed ticket independent and adds S30a-specific sideband summaries
...
TICKET = "1783829521.2904.27150c01"
WORKER = "testbeam-laptop-2"
SLUG = "s30a_waveform_curvature_timing_pedestal_disentanglement_bakeoff"
TITLE = "S30a waveform curvature timing-pedestal disentanglement bakeoff"
OUT = ROOT / "reports" / f"{TICKET}__{SLUG}"
COMMAND = (
    f"{sys.executable} "
    "scripts/s30a_1783829521_2904_27150c01_waveform_curvature_timing_pedestal_bakeoff.py"
)
...
def sideband_tables() -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    sidebands.to_csv(OUT / "s30a_curvature_timing_pedestal_sidebands.csv", index=False)
    ...
    view.to_csv(OUT / "s30a_input_view_metrics.csv", index=False)
...
def rewrite_metadata(started: float) -> None:
    ...
    report = f"""# S30a: waveform curvature timing-pedestal disentanglement bakeoff
    ...
    result.update(
        {
            ...
            "ticket_scope": "waveform curvature timing-pedestal disentanglement bakeoff",
            "raw_vs_pedestal_subtracted": {
                ...
                "evidence_table": "s30a_input_view_metrics.csv",
            },
            "sideband_audits": {
                ...
                "evidence_table": "s30a_curvature_timing_pedestal_sidebands.csv",
            },
            "artifacts": {
                **result["artifacts"],
                "s30a_sidebands": "s30a_curvature_timing_pedestal_sidebands.csv",
                "s30a_input_view_metrics": "s30a_input_view_metrics.csv",
            },
            "completion_audit": {
