...
def main() -> int:
    ...
    parser.add_argument("--config", type=Path, default=Path("configs/p01h_1781126846_2155_5b7831ad_time_local_latent_residualization_gate.json"))
    ...
    next_ticket = "P01m: event-block shuffled downstream transfer falsifier for the P01h residual-fusion gate"
    result = {
