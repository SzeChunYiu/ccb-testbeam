...
## Reproducibility
```bash
uv run --with uproot --with numpy --with pandas --with scikit-learn python reports/1781015988.1952.109d4b1d/p02d_1781015988_1952_109d4b1d_early_peak_timing_tails.py --config reports/1781015988.1952.109d4b1d/p02d_1781015988_1952_109d4b1d_config.json
```
