#!/usr/bin/env python3
"""S18i: support-matched external timing transfer with monotone constraints."""
...
os.environ.setdefault("MPLCONFIGDIR", "reports/1781109770.1737.0fe07286__s18i_astack_support_matched_monotone_transfer/.mplconfig")
...
def write_report(
    ...
    report = f"""# S18i: A-stack support-matched external timing transfer with monotone constraints
...
def main() -> int:
    ...
    parser.add_argument("--config", type=Path, default=Path("configs/s18i_1781109770_1737_0fe07286_astack_support_matched_monotone_transfer.json"))
    ...
    result = {
        ...
        "git_commit": git_head(),
        "next_tickets": [
            "S18k: validate the S18i support-matched monotone transfer under fixed-efficiency per-run amplitude quantile gates to separate pulse-selection support loss from CFD interpolation noise."
        ],
    }
