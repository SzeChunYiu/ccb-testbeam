...
| New study tickets | done | Appended `#2513`, `#2514`, and `#2515` with `project:testbeam`; `#2514` has since been claimed by `worker:testbeam-laptop-4`. |
...
| Current board | done | Final queue audit reports `open=2 claimed=1 done=115`. |
