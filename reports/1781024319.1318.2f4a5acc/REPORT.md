...
- **Ticket:** `1781024319.1318.2f4a5acc`
...
The raw all-three App.I gate reproduces the parent S07e population before any S07g result is used. The S07f unnormalized injection number is also reproduced from the same raw ROOT: RF AUC 0.822118 versus the prior 0.822118.
...
After removing the peak-amplitude nuisance channel, the all-three shape-only RF still reaches ROC AUC 0.823 [0.802, 0.846], compared with the traditional timing/template score 0.607 [0.599, 0.620]. Under positive-charge preservation, the RF reaches 0.823 [0.802, 0.846] versus traditional 0.605 [0.598, 0.617].
