#!/usr/bin/env python3
"""S10d: two-pulse pile-up amplitude by S10c stratum.

This ticket follows S10c, but replaces the binary downstream occupancy with an
event-level two-pulse secondary-fraction estimate.  All predictions are made
with the event's source run held out from template building and ML training.
"""
...
def main() -> int:
    ...
    result = {
        ...
        "ticket": TICKET,
        "worker": WORKER,
        "title": "two-pulse template pile-up amplitude by stratum",
